...
OUTPUT_PATH = Path(
    "graphics/fonts/thai/glyphs/0119_kho_khai.png"
)
...
def load_reference_grid() -> Image.Image:
    """
    ภาพอ้างอิงถูกขยายไว้เป็น Preview ขนาด 256×256
    จึงย่อกลับเป็นกริด 16×16 ด้วย NEAREST เพียงครั้งเดียว
    โดยไม่ครอปหรือเปลี่ยนสัดส่วนเพิ่มเติม
    """
...
def main() -> None:
    ...
    for x, y in main_pixels:
        ...
        for shadow_x, shadow_y in candidates:
            if not (
