...
ALIGNED(4) const u16 gFontThaiShapedGlyphs[] = INCGFX_U16("graphics/fonts/thai_shaped.png", ".latfont");
const u16 gFontThaiShapedGlyphCount = ARRAY_COUNT(gFontThaiShapedGlyphs) / 0x20;
ALIGNED(4) const u8 gFontNormalLatinGlyphWidths[] = {
    ...
    10, 10, 10, 10, 10, 10, 10, 10, 14, 14, 14, 13, 10, 14, 15, 14,
    15, 16, 14, 13, 13, 13, 16, 16, 16, 14, 14, 14, 15, 14, 15, 14,
    13, 14, 13, 15, 14, 15, 14, 14, 14, 14, 14, 14, 15, 14, 15, 15,
    14, 14, 15,  4,  3,  7,  4,  4,  5,  3,  4,  4, 10, 12,  8,  9,
     9,  4,  3,  3,  4,  4,  3,  8,  7, 10,  8,  3,  3,  3,  3,  3,
     3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,
     3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,
     3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,
     3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,  3,
